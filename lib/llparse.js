...
class TransformAPI {
  toLower() {
    return new internal.transform.Transform('toLower');
  }
}
...
class LLParse {
  ...
  property(type, name) {
    assert.strictEqual(typeof type, 'function',
      'The first argument of `.property()` must be a function');
    assert.strictEqual(typeof name, 'string',
      'The second argument of `.property()` must be a string');
