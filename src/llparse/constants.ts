import { Attribute, Builder as IR, CallingConv, types } from 'bitcode';

import Type = types.Type;

export const CCONV: CallingConv = 'fastcc';

export const BOOL: Type = IR.i(1);
export const INT: Type = IR.i(32);
export const TYPE_INPUT: Type = IR.i(8).ptr();
export const TYPE_OUTPUT: Type = IR.i(8).ptr();
export const TYPE_MATCH: Type = INT;
export const TYPE_INDEX: Type = IR.i(64);
export const TYPE_ERROR: Type = INT;
export const TYPE_REASON: Type = IR.i(8).ptr();
export const TYPE_DATA: Type = IR.i(8).ptr();
export const TYPE_STATUS: Type = IR.i(32);

// TODO(indutny): although it works through zero extension, is there any
// cross-platform way to do it?
export const TYPE_INTPTR: Type = IR.i(64);
...
export const USER_TYPES: Map<string, Type> = new Map([
  [ 'i8', IR.i(8) ],
  [ 'i16', IR.i(16) ],
  [ 'i32', IR.i(32) ],
  [ 'i64', IR.i(64) ],
